        ...
        <section>
            <div className="container grid grid-cols-1 md:grid-cols-2 space-y-6 md:space-y-0 gap-12">
                ...
                <div className='relative ' >
                    ...
                    transition={{
                        duration:0.8 , delay:1.3 ,   ease: "easeInOut"
                    }}
                ...
                <div className='flex flex-col justify-center'>
                    ...
                    <div className=" text-center md:text-left space-y-4 lg:max-w-[450px] ml-60
                    ">
                        <motion.h1  variants = {fadeUp(0.7)}  initial = "hidden" whileInView = "show" className='text-3xl lg:text-4xl font-semibold mt-30'>Refresh Your World with Fanta</motion.h1>
                    <motion.p  variants = {fadeUp(0.9)}  initial = "hidden" whileInView = "show" className='text-gray-500 mt-4' >
                    ...
                    <button className="rounded-full border-2 border-orange-500 px-6 py-3 font-semibold text-orange-500 transition-all duration-300 hover:bg-orange-500 hover:text-white hover:scale-105 mt-5 w-30 ml-28">
  Buy Now
</button>
                    </div>
                </div>
